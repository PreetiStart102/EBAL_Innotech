...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // This code swaps the blocks every 13 seconds (13000 milliseconds)
    setInterval(() => {
...
// =========================================
// IN-PAGE COURSE REGISTRATION FORM HANDLER
// =========================================
document.addEventListener('DOMContentLoaded', function () {
    const inPageForm = document.getElementById('ebalInPageRegForm');
    const successMsg = document.getElementById('ebalInPageSuccessMsg');
    ...
    // On solution page, clicking navbar register buttons smoothly scrolls to the form section
    document.querySelectorAll('.btn-nav-action, .scroll-to-registration').forEach(function (btn) {
